...
require 'controladores/camiones.php';
require 'controladores/vales.php';
require 'controladores/pedidos.php';
require 'controladores/llaves.php';
require 'controladores/bank.php';
require 'controladores/cobroVales.php';
require 'controladores/activoVales.php';
require 'controladores/activoPedidos.php';
require 'controladores/detalles.php';
...
$recursos_existentes = array('login','camiones','vales','pedidos','llave','accesos','statusVale','activoVale','activoPedido','detalles');
...
switch ($metodo) {
    ...
    case 'delete':
        if (method_exists($recurso, $metodo)) {
           $respuesta = call_user_func(array($recurso, $metodo), $_GET);
